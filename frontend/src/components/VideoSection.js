...
const VideoSection = ({ session }) => {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      const diff = new Date(session.scheduledAt) - new Date();
  ...
  const fetchToken = useCallback(async () => {
    ...
    try {
      ...
      setTokenError(err?.message || 'Stream not available');
    } finally {
    ...
    return (
      ...
      >
        ...
        <View style={styles.fullscreenContainer}>
          <WebView {...webViewProps} style={styles.fullscreenWebview} />
  ...
  return (
    <View style={styles.container}>
      <View style={styles.videoWrapper}>
        ...
        {/* UPCOMING placeholder with countdown */}
        ...
        {/* Bottom controls: minimize + fullscreen */}
        {playerUrl && !tokenLoading && !tokenError && (
